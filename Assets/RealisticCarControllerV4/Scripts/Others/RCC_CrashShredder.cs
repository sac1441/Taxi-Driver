...
/// <summary>
/// Operates a spinning shredder obstacle in the damage demo scene. The shredder is attached via a
/// ConfigurableJoint hinge and continuously applies torque to rotate and shred vehicles on contact.
/// </summary>
...
public class RCC_CrashShredder : RCC_Core {
    ...
    /// <summary>
    /// Rigidbody component attached to this shredder.
    /// </summary>
    private Rigidbody rigid;

    /// <summary>
    /// Axis direction of the continuous torque applied to spin the shredder.
    /// </summary>
    [Tooltip("Axis direction of the continuous torque applied to spin the shredder.")]
    public Vector3 direction;

    /// <summary>
    /// Strength of the torque applied each physics step to maintain the shredder's rotation.
    /// </summary>
    [Tooltip("Strength of the torque applied each physics step to maintain the shredder's rotation.")]
    [Min(0f)]
