...
public class RCC_ScriptHeaderPreviewWindow : EditorWindow {
    ...
    /// <summary>
    /// Opens the preview window with the original and header-inserted script contents side by side.
    /// </summary>
    /// <param name="path">The path of the script being previewed (used for the window title).</param>
    /// <param name="originalContent">The current contents of the script before the header is inserted.</param>
    /// <param name="previewContent">The proposed contents of the script after the header is inserted.</param>
